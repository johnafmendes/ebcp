...
// 	echo $valor;
	...
	// Guarda inicial
	?><img src=../../resources/images/p.png width=<?php echo $fino?>
	height=<?php echo $altura?> border=0><img src=../../resources/images/b.png width=<?php echo $fino?>
	height=<?php echo $altura?> border=0><img src=../../resources/images/p.png width=<?php echo $fino?>
	height=<?php echo $altura?> border=0><img src=../../resources/images/b.png width=<?php echo $fino?>
	height=<?php echo $altura?> border=0><img
	<?php
	$texto = $valor;
	if ((strlen ( $texto ) % 2) != 0) {
		$texto = "0" . $texto;
	...
	while ( strlen ( $texto ) > 0 ) {
		...
		for($i = 1; $i < 11; $i += 2) {
			...
			?>src=../../resources/images/p.png width=<?php echo $f1?> height=<?php echo $altura?>
	border=0><img
	<?php
			if (substr ( $f, $i, 1 ) == "0") {
				$f2 = $fino;
			...
			?>
	src=../../resources/images/b.png width=<?php echo $f2?> height=<?php echo $altura?>
	border=0><img <?php
		}
	}
	...
	width=<?php echo $largo?> height=<?php echo $altura?> border=0><img src=../../resources/images/b.png width=<?php echo $fino?>
	height=<?php echo $altura?> border=0><img src=../../resources/images/p.png width=<?php echo 1?> height=<?php echo $altura?>
	border=0>
<?php
} // Fim da função
