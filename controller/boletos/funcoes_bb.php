...
// | Desenvolvimento Boleto Banco do Brasil: Daniel William Schultz / Leandro Maniezo / RogÃ©rio Dias Pereira / Romeu Medeiros|
// +-------------------------------------------------------------------------------------------------------------------------+
...
if ($dadosboleto["formatacao_convenio"] == "6") {
	...
	if ($dadosboleto["formatacao_nosso_numero"] == "1") {
		...
		// Nosso nÃºmero de atÃ© 5 dÃ­gitos
	...
	if ($dadosboleto["formatacao_nosso_numero"] == "2") {
		...
		// Nosso nÃºmero de atÃ© 17 dÃ­gitos
		$nservico = "21";
...
//Guarda inicial
?><img src=../../resources/images/p.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=../../resources/images/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=../../resources/images/p.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=../../resources/images/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
<?php
$texto = $valor ;
if((strlen($texto) % 2) <> 0){
...
?>
    src=../../resources/images/p.png width=<?php echo $f1?> height=<?php echo $altura?> border=0><img 
<?php
    if (substr($f,$i,1) == "0") {
      $f2 = $fino ;
    }else{
...
?>
    src=../../resources/images/b.png width=<?php echo $f2?> height=<?php echo $altura?> border=0><img 
<?php
  }
}
...
// Draw guarda final
?>
src=../../resources/images/p.png width=<?php echo $largo?> height=<?php echo $altura?> border=0><img 
src=../../resources/images/b.png width=<?php echo $fino?> height=<?php echo $altura?> border=0><img 
src=../../resources/images/p.png width=<?php echo 1?> height=<?php echo $altura?> border=0> 
  <?php
} //Fim da funÃ§Ã£o
