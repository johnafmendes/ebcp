...
// 		echo $_SESSION['idInstituicao'];
		$listaConcursos = $concursoDAO->listarConcursosPorIdInstituicao($_SESSION['idInstituicao']);
...
// 		$opcoesEscolaridades = opcoesEscolaridades();
		$str = <<<FORM
			<form name="formRelatorio" method="post" action="?nivel=painel_relatorio&acao=abrir_relatorio" >
				<table cellpadding="5">
					<tr>
