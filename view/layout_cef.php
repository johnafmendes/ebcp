...
<BODY text=#000000 bgColor=#ffffff topMargin=0 rightMargin=0>
	<table cellspacing=0 cellpadding=0 width=666 border=0>
		<TBODY>
			<TR>
				<TD class=ct width=666><img height=1 src=../../resources/images/6.png
	...
	<table cellspacing=0 cellpadding=0 width=666 border=0>
		<tr>
			<td class=cp width=150><span class="campo"><IMG
					src="../../resources/images/logocaixa.jpg" width="150" height="40"
					border=0></span></td>
			<td width=3 valign=bottom><img height=22
				src=../../resources/images/3.png width=2 border=0></td>
...
<?php echo $dadosboleto["linha_digitavel"]?>
		...
		<tbody>
			<tr>
				<td colspan=5><img height=2 src=../../resources/images/2.png width=666
					border=0></td>
			</tr>
		</tbody>
	</table>
		...
		<tbody>
			...
			<tr>
				<td class=cp valign=top width=7 height=12><img height=12
					src=../../resources/images/1.png width=1 border=0></td>
				<td class=cp valign=top width=268 height=12><span class="campo"><?php echo $dadosboleto["cedente"]; ?></span></td>
				<td class=cp valign=top width=7 height=12><img height=12
					src=../../resources/images/1.png width=1 border=0></td>
  ...
  <?php echo $dadosboleto["nosso_numero"]?>
			...
			<tr>
				<td valign=top width=7 height=1><img height=1
					src=../../resources/images/2.png width=7 border=0></td>
				<td valign=top width=268 height=1><img height=1
					src=../../resources/images/2.png width=268 border=0></td>
				<td valign=top width=7 height=1><img height=1
					src=../../resources/images/2.png width=7 border=0></td>
				<td valign=top width=156 height=1><img height=1
					src=../../resources/images/2.png width=156 border=0></td>
				<td valign=top width=7 height=1><img height=1
					src=../../resources/images/2.png width=7 border=0></td>
				<td valign=top width=34 height=1><img height=1
					src=../../resources/images/2.png width=34 border=0></td>
				<td valign=top width=7 height=1><img height=1
					src=../../resources/images/2.png width=7 border=0></td>
				<td valign=top width=53 height=1><img height=1
					src=../../resources/images/2.png width=53 border=0></td>
				<td valign=top width=7 height=1><img height=1
					src=../../resources/images/2.png width=7 border=0></td>
				<td valign=top width=120 height=1><img height=1
					src=../../resources/images/2.png width=120 border=0></td>
			</tr>
		</tbody>
	</table>
	<table cellspacing=0 cellpadding=0 border=0>
  ...
  <?php echo $dadosboleto["valor_boleto"]?>
			...
			<tr>
				...
				<td valign=top width=113 height=1><img height=1
					src=../../resources/images/2.png width=113 border=0></td>
				<td valign=top width=7 height=1><img height=1
					src=../../resources/images/2.png width=7 border=0></td>
				<td valign=top width=72 height=1><img height=1
					src=../../resources/images/2.png width=72 border=0></td>
				<td valign=top width=7 height=1><img height=1
					src=../../resources/images/2.png width=7 border=0></td>
				<td valign=top width=132 height=1><img height=1
					src=../../resources/images/2.png width=132 border=0></td>
				<td valign=top width=7 height=1><img height=1
					src=../../resources/images/2.png width=7 border=0></td>
				<td valign=top width=134 height=1><img height=1
					src=../../resources/images/2.png width=134 border=0></td>
				<td valign=top width=7 height=1><img height=1
					src=../../resources/images/2.png width=7 border=0></td>
		...
		<tbody>
			...
			<tr>
				...
				<td valign=top width=112 height=1><img height=1
					src=../../resources/images/2.png width=112 border=0></td>
				<td valign=top width=7 height=1><img height=1
					src=../../resources/images/2.png width=7 border=0></td>
				<td valign=top width=113 height=1><img height=1
					src=../../resources/images/2.png width=113 border=0></td>
  ...
  <?php echo $dadosboleto["sacado"]?>
			...
			<tr>
				...
				<td valign=top width=659 height=1><img height=1
					src=../../resources/images/2.png width=659 border=0></td>
			</tr>
		</tbody>
	</table>
	<table cellspacing=0 cellpadding=0 border=0>
  ...
  <?php echo ($data_venc != "") ? $dadosboleto["data_vencimento"] : "Contra Apresentação"?>
			...
			<tr>
				...
				<td valign=top width=472 height=1><img height=1
					src=../../resources/images/2.png width=472 border=0></td>
				<td valign=top width=7 height=1><img height=1
					src=../../resources/images/2.png width=7 border=0></td>
				<td valign=top width=180 height=1><img height=1
					src=../../resources/images/2.png width=180 border=0></td>
     ...
     <?php echo $dadosboleto["nosso_numero"]?>
			...
			<tr>
				...
				<td valign=top width=133 height=1><img height=1
					src=../../resources/images/2.png width=133 border=0></td>
				<td valign=top width=7 height=1><img height=1
					src=../../resources/images/2.png width=7 border=0></td>
				<td valign=top width=62 height=1><img height=1
					src=../../resources/images/2.png width=62 border=0></td>
				<td valign=top width=7 height=1><img height=1
					src=../../resources/images/2.png width=7 border=0></td>
				<td valign=top width=34 height=1><img height=1
					src=../../resources/images/2.png width=34 border=0></td>
				...
				<td valign=top width=102 height=1><img height=1
					src=../../resources/images/2.png width=102 border=0></td>
				<td valign=top width=7 height=1><img height=1
					src=../../resources/images/2.png width=7 border=0></td>
				<td valign=top width=180 height=1><img height=1
					src=../../resources/images/2.png width=180 border=0></td>
   ...
   <?php echo $dadosboleto["valor_boleto"]?>
			...
			<tr>
				<td valign=top width=7 height=1><img height=1
					src=../../resources/images/2.png width=7 border=0></td>
				<td valign=top width=7 height=1><img height=1
					src=../../resources/images/2.png width=75 border=0></td>
				<td valign=top width=7 height=1><img height=1
					src=../../resources/images/2.png width=7 border=0></td>
				<td valign=top width=31 height=1><img height=1
					src=../../resources/images/2.png width=31 border=0></td>
				<td valign=top width=7 height=1><img height=1
					src=../../resources/images/2.png width=7 border=0></td>
				<td valign=top width=83 height=1><img height=1
					src=../../resources/images/2.png width=83 border=0></td>
				<td valign=top width=7 height=1><img height=1
					src=../../resources/images/2.png width=7 border=0></td>
				<td valign=top width=43 height=1><img height=1
					src=../../resources/images/2.png width=43 border=0></td>
				<td valign=top width=7 height=1><img height=1
					src=../../resources/images/2.png width=7 border=0></td>
				<td valign=top width=103 height=1><img height=1
					src=../../resources/images/2.png width=103 border=0></td>
				<td valign=top width=7 height=1><img height=1
					src=../../resources/images/2.png width=7 border=0></td>
				<td valign=top width=102 height=1><img height=1
					src=../../resources/images/2.png width=102 border=0></td>
			...
			<tr>
				<td align=right width=10><table cellspacing=0 cellpadding=0 border=0
						...
						<tbody>
							...
							<tr>
								<td valign=top width=7 height=1><img height=1
									src=../../resources/images/2.png width=1 border=0></td>
							</tr>
						</tbody>
					</table></td>
		...
		<tbody>
			<tr>
				<td valign=top width=666 height=1><img height=1
					src=../../resources/images/2.png width=666 border=0></td>
			</tr>
		</tbody>
	</table>
	<table cellspacing=0 cellpadding=0 border=0>
