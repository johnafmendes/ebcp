...
<BODY text=#000000 bgColor=#ffffff topMargin=0 rightMargin=0>
	...
	<table width=666 cellspacing=5 cellpadding=0 border=0 align=Default>
		<tr>
			<td width=41><IMG SRC="../../resources/images/logo_empresa.png"></td>
	...
	<table cellspacing=0 cellpadding=0 width=666 border=0>
		<tr>
			<td class=cp width=150><span class="campo"><IMG
					src="../../resources/images/logosicredi.jpg" width="150" height="40" border=0></span></td>
			<td width=3 valign=bottom><img height=22 src=../../resources/images/3.png width=2
				border=0></td>
...
<?php echo $dadosboleto["linha_digitavel"]?>
		...
		<tbody>
			<tr>
				<td colspan=5><img height=2 src=../../resources/images/2.png width=666 border=0></td>
			</tr>
		</tbody>
	</table>
		...
		<tbody>
			<tr>
				<td class=ct valign=top width=7 height=13><img height=13
					src=../../resources/images/1.png width=1 border=0></td>
  ...
  <?php echo $dadosboleto["nosso_numero"]?>
			...
			<tr>
				<td valign=top width=7 height=1><img height=1 src=../../resources/images/2.png
					width=7 border=0></td>
				<td valign=top width=298 height=1><img height=1 src=../../resources/images/2.png
					width=298 border=0></td>
				<td valign=top width=7 height=1><img height=1 src=../../resources/images/2.png
					width=7 border=0></td>
				<td valign=top width=126 height=1><img height=1 src=../../resources/images/2.png
					width=126 border=0></td>
				<td valign=top width=7 height=1><img height=1 src=../../resources/images/2.png
					width=7 border=0></td>
				<td valign=top width=34 height=1><img height=1 src=../../resources/images/2.png
					width=34 border=0></td>
				<td valign=top width=7 height=1><img height=1 src=../../resources/images/2.png
					width=7 border=0></td>
				<td valign=top width=53 height=1><img height=1 src=../../resources/images/2.png
					width=53 border=0></td>
				<td valign=top width=7 height=1><img height=1 src=../../resources/images/2.png
					width=7 border=0></td>
				<td valign=top width=120 height=1><img height=1 src=../../resources/images/2.png
  ...
  <?php echo $dadosboleto["valor_boleto"]?>
			...
			<tr>
				<td valign=top width=7 height=1><img height=1 src=../../resources/images/2.png
					width=7 border=0></td>
				<td valign=top width=113 height=1><img height=1 src=../../resources/images/2.png
					width=113 border=0></td>
				<td valign=top width=7 height=1><img height=1 src=../../resources/images/2.png
					width=7 border=0></td>
				<td valign=top width=72 height=1><img height=1 src=../../resources/images/2.png
					width=72 border=0></td>
				<td valign=top width=7 height=1><img height=1 src=../../resources/images/2.png
					width=7 border=0></td>
				<td valign=top width=132 height=1><img height=1 src=../../resources/images/2.png
					width=132 border=0></td>
				<td valign=top width=7 height=1><img height=1 src=../../resources/images/2.png
					width=7 border=0></td>
				<td valign=top width=134 height=1><img height=1 src=../../resources/images/2.png
					width=134 border=0></td>
				<td valign=top width=7 height=1><img height=1 src=../../resources/images/2.png
					width=7 border=0></td>
				<td valign=top width=180 height=1><img height=1 src=../../resources/images/2.png
	...
	<table cellspacing=0 cellpadding=0 border=0>
		<tbody>
			...
			<tr>
				...
				<td valign=top width=7 height=1><img height=1 src=../../resources/images/2.png
					width=7 border=0></td>
				<td valign=top width=112 height=1><img height=1 src=../../resources/images/2.png
  ...
  <?php echo $dadosboleto["sacado"]?>
			...
			<tr>
				<td valign=top width=7 height=1><img height=1 src=../../resources/images/2.png
					width=7 border=0></td>
				<td valign=top width=659 height=1><img height=1 src=../../resources/images/2.png
  ...
  <?php echo $dadosboleto["demonstrativo3"]?><br>
	...
	<table cellspacing=0 cellpadding=0 width=666 border=0>
		...
		<tbody>
			...
			<tr>
				<td class=ct width=666><img height=1 src=../../resources/images/6.png width=665
					border=0></td>
			</tr>
		</tbody>
	</table>
...
<?php echo $dadosboleto["linha_digitavel"]?>
  ...
  <?php echo $dadosboleto["data_vencimento"]?>
			...
			<tr>
				<td valign=top width=7 height=1><img height=1 src=../../resources/images/2.png
					width=7 border=0></td>
				<td valign=top width=472 height=1><img height=1 src=../../resources/images/2.png
   ...
   <?php echo $dadosboleto["data_processamento"]?>
     ...
     <?php echo $dadosboleto["nosso_numero"]?>
			...
			<tr>
				...
				<td valign=top width=7 height=1><img height=1 src=../../resources/images/2.png
					width=7 border=0></td>
				<td valign=top width=153 height=1><img height=1 src=../../resources/images/2.png
					width=153 border=0></td>
				<td valign=top width=7 height=1><img height=1 src=../../resources/images/2.png
					width=7 border=0></td>
				<td valign=top width=62 height=1><img height=1 src=../../resources/images/2.png
				...
				<td valign=top width=7 height=1><img height=1 src=../../resources/images/2.png
					width=7 border=0></td>
				<td valign=top width=82 height=1><img height=1 src=../../resources/images/2.png
 ...
 <?php echo $dadosboleto["quantidade"]?>
   ...
   <?php echo $dadosboleto["valor_boleto"]?>
			...
			<tr>
				...
				<td valign=top width=7 height=1><img height=1 src=../../resources/images/2.png
					width=7 border=0></td>
				<td valign=top width=31 height=1><img height=1 src=../../resources/images/2.png
					width=31 border=0></td>
				<td valign=top width=7 height=1><img height=1 src=../../resources/images/2.png
					width=7 border=0></td>
				<td valign=top width=83 height=1><img height=1 src=../../resources/images/2.png
				...
				<td valign=top width=7 height=1><img height=1 src=../../resources/images/2.png
					width=7 border=0></td>
				<td valign=top width=123 height=1><img height=1 src=../../resources/images/2.png
...
<?php echo $dadosboleto["instrucoes4"]; ?></FONT><br>
						...
						<tbody>
							...
							<tr>
								...
								<td valign=top width=180 height=1><img height=1
									src=../../resources/images/2.png width=180 border=0></td>
							</tr>
						</tbody>
					</table></td>
			</tr>
	...
	<table cellspacing=0 cellpadding=0 width=666 border=0>
		<tbody>
			<tr>
				<td valign=top width=666 height=1><img height=1 src=../../resources/images/2.png
